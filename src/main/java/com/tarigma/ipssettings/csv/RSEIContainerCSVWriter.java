package com.tarigma.ipssettings.csv;
 ...
 */
public class RSEIContainerCSVWriter {
	
	private static final Logger LOG = LoggerFactory.getLogger(RSEIContainerCSVWriter.class);

	private static Function<Block, String> nameGetter = block -> block.getName();

	private static Function<Block, String> descriptionGetter = block -> block.getDescription();
